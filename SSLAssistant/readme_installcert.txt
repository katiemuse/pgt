...
The included certificates and installation instructions are for Nginx version .

BEFORE YOU BEGIN
You must have admin access to the server where you will install the certificate. If you use a hosted web service or do not have access to your server, forward this ZIP file to your host admin or technical assistant who will install your Symantec RSA certificate:
- ssl_certificate.crt
- IntermediateCA.crt
...
https://knowledge.symantec.com/support/ssl-certificates-support/index?page=content&id=SO25653
