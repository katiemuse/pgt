...
/**
 * @ngdoc function
 * @name pardotInteractiveGuidedTour.controller:SalesCloudEngageDrawerCtrl
 * @description
 * # SalesCloudEngageDrawerCtrl
 * Controller of the pardotInteractiveGuidedTour
 */
angular.module('pardotInteractiveGuidedTour')
  .controller('SalesCloudEngageDrawerCtrl', function ($scope, WizardHandler, TopNavbar, Steps, Hotspots, Drawer, $timeout) {
