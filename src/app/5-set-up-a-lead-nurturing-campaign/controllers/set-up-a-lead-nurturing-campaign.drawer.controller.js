...
/**
 * @ngdoc function
 * @name pardotInteractiveGuidedTour.controller:SetUpALeadNurturingCampaignDrawerCtrl
 * @description
 * # SetUpALeadNurturingCampaignDrawerCtrl
 * Controller of the pardotInteractiveGuidedTour
 */
angular.module('pardotInteractiveGuidedTour')
  .controller('SetUpALeadNurturingCampaignDrawerCtrl', function ($scope, WizardHandler, TopNavbar, Steps, Hotspots, Drawer, $timeout) {
