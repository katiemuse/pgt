...
/**
 * @ngdoc function
 * @name pardotInteractiveGuidedTour.controller:PersonalizedEmailDrawerCtrl
 * @description
 * # PersonalizedEmailDrawerCtrl
 * Controller of the pardotInteractiveGuidedTour
 */
angular.module('pardotInteractiveGuidedTour')
  .controller('PersonalizedEmailDrawerCtrl', function ($scope, WizardHandler, TopNavbar, Steps, Hotspots, Drawer, $timeout) {
