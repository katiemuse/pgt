...
/**
 * @ngdoc function
 * @name pardotInteractiveGuidedTour.controller:landingPageBuilderCtrl
 * @description
 * # landingPageBuilderCtrl
 * Controller of the pardotInteractiveGuidedTour
 */
angular.module('pardotInteractiveGuidedTour')
  .controller('LandingPageBuilderCtrl', function ($scope, $timeout, Steps, WizardHandler, Drawer, $state) {
    ...
    $scope.$watch("formBuilder.image", function(newValue, oldValue){
