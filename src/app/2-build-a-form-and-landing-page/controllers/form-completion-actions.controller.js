...
/**
 * @ngdoc function
 * @name pardotInteractiveGuidedTour.controller:FormCompletionActionsCtrl
 * @description
 * # buildAFormAndLandingPageCtrl
 * Controller of the pardotInteractiveGuidedTour
 */
angular.module('pardotInteractiveGuidedTour')
  .controller('FormCompletionActionsCtrl', function ($scope, $timeout, Steps, WizardHandler, Hotspots) {
    ...
    $scope.$watch("response.action",function(newValue, oldValue){
