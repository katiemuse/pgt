...
/**
 * @ngdoc function
 * @name pardotInteractiveGuidedTour.controller:SendEmailCtrl
 * @description
 * # SendEmailCtrl
 * Controller of the pardotInteractiveGuidedTour
 */
angular.module('pardotInteractiveGuidedTour')
  .controller('SendEmailCtrl', function ($scope, WizardHandler, Steps, Hotspots) {
    ...
    $scope.$watch('list.sendTo', function(newValue, oldValue){
