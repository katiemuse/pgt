...
import AddAnObjectController from './controllers/1-add-an-object.controller';
import AddAnObjectDrawerController from './controllers/1-add-an-object.drawer.controller';
import HerokuConnectController from './controllers/2-heroku-connect.controller';
import HerokuConnectDrawerController from './controllers/2-heroku-connect.drawer.controller';
import AddAnExternalObjectController from './controllers/4-add-an-external-object.controller';
import AddAnExternalObjectDrawerController from './controllers/4-add-an-external-object.drawer.controller';
import EinsteinBuilderController from './controllers/3-einstein-builder.controller';
import EinsteinBuilderDrawerController from './controllers/3-einstein-builder.drawer.controller';
...
import SetupAWorkflowController from './controllers/1-setup-a-workflow.controller';
import SetupAWorkflowDrawerController from './controllers/1-setup-a-workflow.drawer.controller';
import ChooseAnObjectForTheProcessController from './controllers/2-choose-an-object-for-the-process.controller';
import ChooseAnObjectForTheProcessDrawerController from './controllers/2-choose-an-object-for-the-process.drawer.controller';
import AddCriteriaController from './controllers/3-add-criteria.controller';
import AddCriteriaDrawerController from './controllers/3-add-criteria.drawer.controller';
import AddActionsController from './controllers/4-add-actions.controller';
import AddActionsDrawerController from './controllers/4-add-actions.drawer.controller';
import IotController from './controllers/5-iot.controller';
import IotDrawerController from './controllers/5-iot.drawer.controller';
import CreateANewLightningPageController from './controllers/1-create-a-new-lightning-page.controller';
import CreateANewLightningPageDrawerController from './controllers/1-create-a-new-lightning-page.drawer.controller';
import InstallAPreBuiltComponentFromAppexchangeController from './controllers/3-install-a-pre-built-component-from-appexchange.controller';
import InstallAPreBuiltComponentFromAppexchangeDrawerController from './controllers/3-install-a-pre-built-component-from-appexchange.drawer.controller';
import CreateAnAppFromBaseAndCustomLightningComponentsController from './controllers/2-create-an-app-from-base-and-custom-lightning-components.controller';
import CreateAnAppFromBaseAndCustomLightningComponentsDrawerController from './controllers/2-create-an-app-from-base-and-custom-lightning-components.drawer.controller';
import AddCustomComponentsController from './controllers/4-add-custom-components.controller';
import AddCustomComponentsDrawerController from './controllers/4-add-custom-components.drawer.controller';
import CustomizeAPageLayoutController from './controllers/5-customize-a-page-layout.controller';
import CustomizeAPageLayoutDrawerController from './controllers/5-customize-a-page-layout.drawer.controller';
import CustomizeNavigationController from './controllers/6-customize-navigation.controller';
import CustomizeNavigationDrawerController from './controllers/6-customize-navigation.drawer.controller';
import CreateACustomActionController from './controllers/1-create-a-custom-action.controller';
import CreateACustomActionDrawerController from './controllers/1-create-a-custom-action.drawer.controller';
import CustomizeTheActionBarController from './controllers/2-customize-the-action-bar.controller';
import CustomizeTheActionBarDrawerController from './controllers/2-customize-the-action-bar.drawer.controller';
import CreateALightningAppFromYourPageController from './controllers/3-create-a-lightning-app-from-your-page.controller';
import CreateALightningAppFromYourPageDrawerController from './controllers/3-create-a-lightning-app-from-your-page.drawer.controller';
import OutroController from './controllers/1-outro.controller';
import OutroDrawerController from './controllers/1-outro.drawer.controller';
